...
public class MainActivity extends AppCompatActivity {
     ...
     * @param v
     */
    public void stripPay(View v) {
        StripPayActivity.gotoHere(this, 1001);
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
        StripPayActivity.onActivityResult(requestCode, resultCode, data, new StripPayActivity.CallBack<StripPayActivity.Result>() {
            @Override
            public void call(StripPayActivity.Result data) {
...
//                    @Override
//                    public void onNext(@NonNull MKBaseResultEntity<String> baseResultEntity) {
//                        String payInfo = baseResultEntity.getData();
//
//                        payInfo = "appId=1506419077471142&mhtAmtCurrFlag=1&mhtCharset=UTF-8&mhtCurrencyType=GBP&mhtOrderAmt=101&mhtOrderDetail=087860487031855539&mhtOrderName=087860487031855539&mhtOrderNo=087860487031855539&" +
//                                "mhtOrderStartTime=20171114224558&mhtOrderTimeOut=3600" +
//                                "&mhtOrderType=01&notifyUrl=http://test.hzhaya.com/api/user/pay/ipn/info&payChannelType=90&mhtSignature=2a2a6b290e83ca0c2f76ba2e66864426&mhtSignType=MD5";
//
////                        final String payInfo =  "partner=2088021067956101&seller_id=zhiyoutech@126.com&out_trade_no=1005200958-1381&subject=测试的商品&body=该测试商品的详细描述&total_fee=0.01&service=mobile.securitypay.pay&payment_type=1&_input_charset=utf-8&it_b_pay=30m&sign=XNSKpeslPHprpWSrAkhBwWhgEvZpaaHZqL1q1pz3t2UxblDTGL2swU8M509qnfkBu3khgc3dgR9RgXDAXjWoLi4WNF8YwctKGSm%2BvVB3xGw9pxzY8peaQ%2F0jEzgncoWEitsZx2i2uOeeUJFdtiiTAeK%2FKHXDYABOJ1IyiR4NNHE%2BSKjuhy8K8APxKM4Vyt0IsQJYc%2FAPjHWCSNy9Ma4Dv8sWPYqbNuDzHM%2B3wD2jC00t%2Bbvyq5Zzr59OO%2FarcI8nhuqKz%2FraahsS6u8WZM0leuH%2Bu32%2B%2BHjm%2BwBHkQEFubJ%2BaBFaJnBIECZnLrnBe1nEUT3NmXe%2BYCb2CCtx7cloxQ%3D%3D&sign_type=RSA";
//                        pay.pay(MainActivity.this, payInfo, MkPay.PAY_TYPE_IPAYNOW, new MkPayCallback() {
//                            @Override
//                            public void onPayResult(MkPayResult result) {
